...
<?php
    ...
    $timkiemsql = "SELECT `id`, `khachhang_id`, `trangthai`, `khuyenmai`, `ngayban`, `ngaygiaohang`, `ghichu`,
                        CASE 
                        ...
                        END as trang_thai
                        FROM `donhang`
                        WHERE khachhang_id like '%$keyword%'";
    $res = $conn->query( $timkiemsql );
?>
...
<body>
    <div class="container mt-3">
        ...
        <a href="lietke.php" class="btn btn-outline-danger mb-3">Quay lại</a>
